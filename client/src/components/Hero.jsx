        ...
        <div>
            <div className="relative px-4 md:px-10 pb-4 mt-10 space-y-8">
                ...
                <div className="relative h-[300px] rounded-2xl overflow-hidden shadow-lg flex items-center">
                    ...
                    <div className="relative z-10 pl-8 max-w-2xl">
                        ...
                        <button className="mt-4 px-5 py-3 bg-white text-blue-600 font-medium rounded-xl">
                            Join the Alliance
                        </button>
                    </div>
                </div>
            ...
            <div className='mt-10 flex px-10 justify-between gap-10 '>
                <div className='bg-[rgba(0,85,149,1)] px-10 py-5 rounded-4xl flex-1/2'>
                    ...
                    <button className='flex  gap-2 mt-5 items-center rounded-4xl bg-[rgba(181,214,235,0.58)] px-3 py-6'>
                        <h3 className='text-xl text-white flex items-center gap-2'>Learn more<MdOutlineArrowOutward /></h3>
                    </button>
                </div>
                ...
                <div className='flex flex-col gap-4 flex-1/2 '>
                    <div className='bg-[rgba(58,144,202,0.17)] rounded-4xl py-12 px-10'>
                        ...
                        <button className='px-5 py-2 bg-[rgba(0,85,149,1)] rounded-xl mt-5 text-white'>Calmed Explanatory Documents!</button>
                    </div>
                ...
                <div className="relative w-full md:w-[45%] rounded-xl overflow-hidden shadow-lg text-white">
                    ...
                    <div className="relative z-10 p-6 space-y-4">
                        ...
                        <div className="space-y-3 pt-3">
                            <button className="bg-white text-blue-800 px-4 py-2 rounded-lg font-semibold text-sm">
                        ...
                        <SwiperSlide key={idx}>
                            ...
                            >
                                ...
                                <div className="px-6 py-5">
                                    ...
                                    <button className="bg-amber-50 text-black text-sm font-semibold px-4 py-2 rounded-xl">
                                        Read More →
                                    </button>
                                </div>
                            </div>
